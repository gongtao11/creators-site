      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 text-sm">Sign in to access your content and messages</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" value={password} onChange={e => setPassword(e.target.value)} required
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-sm focus:outline-none focus:ring-2 focus:ring-pink-500/50" placeholder="••••••••" />
              </div>
            </div>
          ...
          <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-6">
            Don&apos;t have an account?{" "}<Link href="/register" className="text-pink-500 hover:text-pink-600 font-medium">Sign Up</Link>
          </p>
        </div>
      </main>
    </div>
